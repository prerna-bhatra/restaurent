...
class SellerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //return $request;
        $seller=new Seller();
        $seller->seller_id=Auth::user();
        $seller->name=$request->name;
        $seller->city='sikar';
        $seller->city='ringus';
        $seller->district='sikar';
        $seller->state='sikar';
        $seller->payment=$request->payment;
        $seller->save();
        $this->handlePaytmRequest( $seller->seller_id,$seller->payment );
    }
    public function handlePaytmRequest( $seller_id, $amount ) {
        ...
        $paramList["seller_id"] = $seller_id;
        $paramList["CUST_ID"] = $seller_id;
    ...
    public function paytmCallback( Request $request ) {
        $seller_id = $request['ORDERID'];
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
            $transaction_id = $request['TXNID'];
            $order = Order::where( 'seller_id', $seller_id )->first();
